...
@section('content')
    ...
    <!-- 🟡 Simple Gold Rate Input Section -->
    <div class="row mb-4">
        <div class="col-12">
                    ...
                    <div class="col-xl-6 mb-4">
                        <div class="card border-0 shadow-sm h-100">
                            <div class="card-header bg-transparent border-0 d-flex justify-content-between align-items-center py-3">
                                ...
                                <a href="{{ route('admin.branch.index') }}" class="btn btn-sm btn-primary d-flex align-items-center">
                                    ...
                                    <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            @forelse($recentBranches as $branch)
                                                <tr>
                                                    <td class="ps-4 fw-medium">{{ $branch->id }}</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                    ...
                    <div class="col-xl-6 mb-4">
                        <div class="card border-0 shadow-sm h-100">
                            <div class="card-header bg-transparent border-0 d-flex justify-content-between align-items-center py-3">
                                ...
                                <a href="{{ route('admin.agent.index') }}" class="btn btn-sm btn-primary d-flex align-items-center">
                                    <i class="ri-external-link-line me-1"></i>View All
                                </a>
                            </div>
                            <div class="card-body p-0">
                                    ...
                                    <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            @forelse($recentAgents as $agent)
                                                <tr>
                                                    <td class="ps-4 fw-medium">{{ $agent->id }}</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0">
