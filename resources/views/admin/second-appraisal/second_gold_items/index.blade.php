...
<div class="container-fluid">
                    ...
                    <div class="row align-items-center gy-2">
                        ...
                        <div class="col-md-8">
                            <div class="d-flex justify-content-md-end gap-2 align-items-center">
                               ...
                               <a href="{{ route('admin.second_gold_items.create') }}" class="btn btn-primary shadow-sm">
                        ...
                        <table class="table align-middle table-hover table-nowrap mb-0" id="goldTable">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="text-uppercase fs-11 fw-bold text-muted">ledger_folio_no</th>
                            ...
                            <tbody>
                                {{-- FIX: Ensure $items is passed from controller --}}
                                @forelse ($items as $item)
                                    <tr>
                                        <td class="ps-4 fw-medium text-muted">
                                            {{-- FIX: Changed $golditems to $items --}}
    ...
    <div class="d-flex align-items-center">
        <div class="avatar-sm bg-soft-warning rounded-circle d-flex align-items-center justify-content-center me-3"
             style="width: 35px; height: 35px; background-color: rgba(255, 193, 7, 0.1); color: #ffc107;">
            <i class="ri-user-3-line fs-5"></i>
        </div>
        <span class="fw-semibold text-dark">{{ $item->ledger_folio_no ?? 'N/A' }}</span>
    </div>
</td>
...
<a href="{{ route('admin.second_gold_items.edit', $item->id) }}" class="btn btn-sm btn-soft-warning">
                                                    <i class="ri-pencil-line align-middle"></i>
                                                </a>
<form id="delete-form-{{ $item->id }}" 
      action="{{ route('admin.second_gold_items.destroy', $item->id) }}" 
      method="POST">
    @csrf
    @method('DELETE')
    <button type="button" 
