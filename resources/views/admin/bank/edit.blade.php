                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="card-title mb-1 text-primary fw-bold">
                                <i class="ri-edit-box-line align-middle me-1"></i> Edit Bank
                            </h4>
                            <p class="text-muted mb-0 small">Update details for <strong>{{ $bank->bank }}</strong></p>
                        </div>
                    ...
                    <form action="{{ route('admin.bank.update', $bank->id) }}" method="POST">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control @error('address') is-invalid @enderror"
                                           ...
                                           name="address" 
                                           rows="2"
                                           placeholder="Enter full registered address">{{ old('address', $bank->address) }}</textarea>
                                    @error('address')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                            ...
                            <button type="submit" class="btn btn-primary px-4">
                                <i class="ri-save-line align-middle me-1"></i> Update Bank
                            </button>
                        </div>
